...
<div class="new_reser">
			<ul>
				<li class="item ddanyo_icon">
					<a href="https://booking.ddnayo.com/booking-calendar-status?accommodationId=14929" target="_blank">
						<i class="icon">홈페이지</i>
						<span class="txt">예약 바로가기</span>
					</a>
				</li>
				<li class="item naver_icon">
					<a href="https://booking.naver.com/booking/3/bizes/726985" target="_blank">
