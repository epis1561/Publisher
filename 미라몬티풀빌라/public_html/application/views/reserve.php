		...
		<div class="subCon01">
			...
			<div class="reser01_02">
				...
				<div class="price_text">            	
					...
					<ul class="reser_li">
						<li><strong>※ 예약 및 문의</strong> : <a href="tel:033-813-1330" style="color:inherit;">070-4464-7881</a>로 전화 주시면 친절히 상담해 드립니다.</li>
						<!-- 계좌적는곳! -->
					</ul>
				</div>
			</div>
				...
				<dl class="reser_dl">
					...
					<dd>
						<ul class="list01">
							...
							<li>입실고객에 한하여 1회(약 3시간) 50% 할인, 2인기준 20,000원 / 사전예약필수</li>
							<li>일반고객 이용시 1회(약 3시간) 2인 기준, 통대여 40,000원 / 1인 추가시마다 10,000원(최대 4인까지 이용) / 현장결제</li>
