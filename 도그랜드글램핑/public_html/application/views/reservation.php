...
<div class="new_reser">
			<ul>
				<li class="ddanyo_icon">
					<a href="https://booking.ddnayo.com/?accommodationId=100545" target="_blank">
						<i class="icon">홈페이지</i>
						<span class="txt">예약 바로가기</span>
					</a>
				</li>
				<!-- <li class="naver_icon">
					<a href="https://booking.naver.com/booking/3/bizes/633927" target="_blank">
