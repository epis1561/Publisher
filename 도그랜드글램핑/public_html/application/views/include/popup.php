...
<style type="text/css">
	/* 팝업레이어 */
	.popup { position:absolute; left: 5px; top: 60px; z-index:1000; max-width:350px; touch-action:auto !important;}
...
<style type="text/css">
	/* 팝업레이어 */
	.containerPop { display:flex; flex-wrap: wrap; position:absolute; left: 7%; top: 120px; max-width:1700px; z-index:10000; touch-action:auto !important;}
...
<?php // if ($_SERVER['REMOTE_ADDR'] == "59.29.3.210") { ?>
	<style>
		.popupBox {position: absolute;top: 15%;right: 10%;width: 350px;z-index: 10000;} 
